...
| Команда без neural | Не зачёт COP, направить на доработку ЛР5 |
...
Forecast Cup = **COP** по учебному плану (≈ 3,75 %+ веса модуля 3). Зачёт COP засчитывается как часть СОР при выполнении порога «Базовый».

ЛР5–6 могут использовать **тот же код**, что COP, но оцениваются отдельно по рубрикам лабораторных.

...
**Компетенции:** ML-3.1, ML-3.2, ML-2.2 (С)  
...
| 5 | **Регрессия (Linear/Ridge) или SARIMA** — кто точнее на **test**? Назовите **метрики** и краткий вывод. |
...
| № | Вопрос |
|---|--------|
| 11 | Прогноз на **несколько дней** вперёд: чем отличается подход «каждый раз прогнозируем **+1 день** и подставляем этот прогноз в признаки» от подхода «**отдельная** модель (или цель) на +1, +2, … +7 день»? |

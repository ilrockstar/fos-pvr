...
**Архитектура ФОС:** групповой сквозной проект (ЛР1–10 = milestones, PRC, peer-review)
...
**Мероприятия по типам КИМ** (модификация на лету, аналитические ловушки, private test COP, адресный блиц по ролям): [integrity_measures.md](../../docs/integrity_measures.md).

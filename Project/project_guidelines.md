...
Мероприятия для проверки **понимания**, а не запрета LLM: [integrity_measures.md](../docs/integrity_measures.md) (модификация на лету, ловушки в квизах, private test COP, блиц по ролям на PRC).

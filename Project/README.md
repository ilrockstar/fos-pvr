...
**Архитектура:** **вариант A** — PRC = финальная защита **того же** группового проекта, что и milestones ЛР1–8  
...
**Вес PRC:** 30 % (+ peer-review 5 %). См. [docs/grading.md](../docs/grading.md).
...
| [peer_review.md](peer_review.md) | Взаимооценка (5 %) |
